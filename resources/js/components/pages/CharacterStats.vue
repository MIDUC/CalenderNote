        ...
        <div v-else-if="user" class="space-y-3">
            ...
            >
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-2xl">⭐</span>
                        <div>
                            <p class="text-xs text-gray-500">Cảnh giới</p>
                            <p class="text-sm font-semibold text-gray-800">
            ...
            >
                ...
                <div class="space-y-3">
                    ...
                    <!-- Attack -->
                    <div
                        class="flex items-center justify-between p-2.5 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg border border-orange-200"
                    >
                        <div class="flex items-center gap-2">
                            <span class="text-xl">⚔️</span>
                    ...
                    <!-- Defense -->
                    <div
                        class="flex items-center justify-between p-2.5 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200"
                    >
                        <div class="flex items-center gap-2">
                            <span class="text-xl">🛡️</span>
                            <span class="text-sm font-semibold text-gray-700"
            ...
            >
                ...
                <div class="mt-3 pt-3 border-t border-gray-200">
                    <div
                        class="flex items-center gap-3 p-2.5 bg-purple-50 rounded-lg border border-purple-200"
                    >
                        <span class="text-2xl">✨</span>
                        <div class="flex-1">
                            ...
                            <p class="text-sm font-bold text-purple-600">
                                {{ user.online_exp_per_5s || 0 }} linh lực/chu
                                thiên
                            </p>
                        </div>
                    </div>
